...
class SearchBarDarkBack extends React.Component{
    state={
        term:'',
        weatherCity:''
    };
    ...
    render (){
        return(
            <form onSubmit={this.onFormSubmit} className="searchbar-form searchbar-form-dark">
...
export default SearchBarDarkBack;